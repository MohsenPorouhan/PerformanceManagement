...
namespace PerformanceManagement.Migrations
{
    ...
    [Migration("20200615052211_add-48")]
    partial class add48
    {
            ...
            modelBuilder.Entity("PerformanceManagement.Models.EvaluationAcceptanceStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 6, 15, 9, 52, 11, 99, DateTimeKind.Local).AddTicks(1701),
                            Title = "تفاهم"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 2,
                            CreatedDate = new DateTime(2020, 6, 15, 9, 52, 11, 101, DateTimeKind.Local).AddTicks(2088),
                            Title = "دستوری"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 3,
                            CreatedDate = new DateTime(2020, 6, 15, 9, 52, 11, 101, DateTimeKind.Local).AddTicks(2105),
                            Title = "صرف نظر"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 4,
                            CreatedDate = new DateTime(2020, 6, 15, 9, 52, 11, 101, DateTimeKind.Local).AddTicks(2110),
                            Title = "نامشخص"
                        });
                });
            ...
            modelBuilder.Entity("PerformanceManagement.Models.NotificationTitle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 6, 15, 9, 52, 11, 106, DateTimeKind.Local).AddTicks(3481),
                            Title = "تغییر وضعیت تفاهم وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 2,
                            CreatedDate = new DateTime(2020, 6, 15, 9, 52, 11, 106, DateTimeKind.Local).AddTicks(4053),
                            Title = "تغییر وضعیت تفاهم شایستگی ها"
                        },
                        new
                        {
                            NotificationTitleId = 3,
                            CreatedDate = new DateTime(2020, 6, 15, 9, 52, 11, 106, DateTimeKind.Local).AddTicks(4065),
                            Title = "تعیین وضعیت سایرارزیاب وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 4,
                            CreatedDate = new DateTime(2020, 6, 15, 9, 52, 11, 106, DateTimeKind.Local).AddTicks(4068),
