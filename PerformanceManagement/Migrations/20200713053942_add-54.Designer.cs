...
namespace PerformanceManagement.Migrations
{
    ...
    [Migration("20200713053942_add-54")]
    partial class add54
    {
            ...
            modelBuilder.Entity("PerformanceManagement.Models.EvaluationAcceptanceStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 7, 13, 10, 9, 41, 577, DateTimeKind.Local).AddTicks(6261),
                            Title = "تفاهم"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 2,
                            CreatedDate = new DateTime(2020, 7, 13, 10, 9, 41, 586, DateTimeKind.Local).AddTicks(7678),
                            Title = "دستوری"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 3,
                            CreatedDate = new DateTime(2020, 7, 13, 10, 9, 41, 586, DateTimeKind.Local).AddTicks(7702),
                            Title = "صرف نظر"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 4,
                            CreatedDate = new DateTime(2020, 7, 13, 10, 9, 41, 586, DateTimeKind.Local).AddTicks(7708),
                            Title = "نامشخص"
                        });
                });
            ...
            modelBuilder.Entity("PerformanceManagement.Models.NotificationTitle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 7, 13, 10, 9, 41, 592, DateTimeKind.Local).AddTicks(7459),
                            Title = "تغییر وضعیت تفاهم وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 2,
                            CreatedDate = new DateTime(2020, 7, 13, 10, 9, 41, 592, DateTimeKind.Local).AddTicks(8378),
                            Title = "تغییر وضعیت تفاهم شایستگی ها"
                        },
                        new
                        {
                            NotificationTitleId = 3,
                            CreatedDate = new DateTime(2020, 7, 13, 10, 9, 41, 592, DateTimeKind.Local).AddTicks(8397),
                            Title = "تعیین وضعیت سایرارزیاب وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 4,
                            CreatedDate = new DateTime(2020, 7, 13, 10, 9, 41, 592, DateTimeKind.Local).AddTicks(8402),
