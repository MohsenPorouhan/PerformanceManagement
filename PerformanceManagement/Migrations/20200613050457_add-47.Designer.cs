...
namespace PerformanceManagement.Migrations
{
    ...
    [Migration("20200613050457_add-47")]
    partial class add47
    {
            ...
            modelBuilder.Entity("PerformanceManagement.Models.EvaluationAcceptanceStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 6, 13, 9, 34, 56, 646, DateTimeKind.Local).AddTicks(6120),
                            Title = "تفاهم"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 2,
                            CreatedDate = new DateTime(2020, 6, 13, 9, 34, 56, 650, DateTimeKind.Local).AddTicks(5489),
                            Title = "دستوری"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 3,
                            CreatedDate = new DateTime(2020, 6, 13, 9, 34, 56, 650, DateTimeKind.Local).AddTicks(5501),
                            Title = "صرف نظر"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 4,
                            CreatedDate = new DateTime(2020, 6, 13, 9, 34, 56, 650, DateTimeKind.Local).AddTicks(5504),
                            Title = "نامشخص"
                        });
                });
            ...
            modelBuilder.Entity("PerformanceManagement.Models.NotificationTitle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 6, 13, 9, 34, 56, 654, DateTimeKind.Local).AddTicks(248),
                            Title = "تغییر وضعیت تفاهم وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 2,
                            CreatedDate = new DateTime(2020, 6, 13, 9, 34, 56, 654, DateTimeKind.Local).AddTicks(807),
                            Title = "تغییر وضعیت تفاهم شایستگی ها"
                        },
                        new
                        {
                            NotificationTitleId = 3,
                            CreatedDate = new DateTime(2020, 6, 13, 9, 34, 56, 654, DateTimeKind.Local).AddTicks(818),
                            Title = "تعیین وضعیت سایرارزیاب وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 4,
                            CreatedDate = new DateTime(2020, 6, 13, 9, 34, 56, 654, DateTimeKind.Local).AddTicks(820),
