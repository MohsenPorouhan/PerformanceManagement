...
namespace PerformanceManagement.Migrations
{
    ...
    [Migration("20200713111137_add-56")]
    partial class add56
    {
            ...
            modelBuilder.Entity("PerformanceManagement.Models.EvaluationAcceptanceStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 7, 13, 15, 41, 37, 227, DateTimeKind.Local).AddTicks(389),
                            Title = "تفاهم"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 2,
                            CreatedDate = new DateTime(2020, 7, 13, 15, 41, 37, 230, DateTimeKind.Local).AddTicks(9000),
                            Title = "دستوری"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 3,
                            CreatedDate = new DateTime(2020, 7, 13, 15, 41, 37, 230, DateTimeKind.Local).AddTicks(9020),
                            Title = "صرف نظر"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 4,
                            CreatedDate = new DateTime(2020, 7, 13, 15, 41, 37, 230, DateTimeKind.Local).AddTicks(9024),
                            Title = "نامشخص"
                        });
                });
            ...
            modelBuilder.Entity("PerformanceManagement.Models.NotificationTitle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 7, 13, 15, 41, 37, 235, DateTimeKind.Local).AddTicks(2598),
                            Title = "تغییر وضعیت تفاهم وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 2,
                            CreatedDate = new DateTime(2020, 7, 13, 15, 41, 37, 235, DateTimeKind.Local).AddTicks(3288),
                            Title = "تغییر وضعیت تفاهم شایستگی ها"
                        },
                        new
                        {
                            NotificationTitleId = 3,
                            CreatedDate = new DateTime(2020, 7, 13, 15, 41, 37, 235, DateTimeKind.Local).AddTicks(3303),
                            Title = "تعیین وضعیت سایرارزیاب وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 4,
                            CreatedDate = new DateTime(2020, 7, 13, 15, 41, 37, 235, DateTimeKind.Local).AddTicks(3307),
