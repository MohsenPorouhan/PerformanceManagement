...
namespace PerformanceManagement.Migrations
{
    ...
    [Migration("20200616064038_add-49")]
    partial class add49
    {
            ...
            modelBuilder.Entity("PerformanceManagement.Models.EvaluationAcceptanceStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 6, 16, 11, 10, 38, 193, DateTimeKind.Local).AddTicks(3146),
                            Title = "تفاهم"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 2,
                            CreatedDate = new DateTime(2020, 6, 16, 11, 10, 38, 194, DateTimeKind.Local).AddTicks(7806),
                            Title = "دستوری"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 3,
                            CreatedDate = new DateTime(2020, 6, 16, 11, 10, 38, 194, DateTimeKind.Local).AddTicks(7819),
                            Title = "صرف نظر"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 4,
                            CreatedDate = new DateTime(2020, 6, 16, 11, 10, 38, 194, DateTimeKind.Local).AddTicks(7822),
                            Title = "نامشخص"
                        });
                });
            ...
            modelBuilder.Entity("PerformanceManagement.Models.NotificationTitle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 6, 16, 11, 10, 38, 199, DateTimeKind.Local).AddTicks(2148),
                            Title = "تغییر وضعیت تفاهم وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 2,
                            CreatedDate = new DateTime(2020, 6, 16, 11, 10, 38, 199, DateTimeKind.Local).AddTicks(2699),
                            Title = "تغییر وضعیت تفاهم شایستگی ها"
                        },
                        new
                        {
                            NotificationTitleId = 3,
                            CreatedDate = new DateTime(2020, 6, 16, 11, 10, 38, 199, DateTimeKind.Local).AddTicks(2710),
                            Title = "تعیین وضعیت سایرارزیاب وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 4,
                            CreatedDate = new DateTime(2020, 6, 16, 11, 10, 38, 199, DateTimeKind.Local).AddTicks(2713),
