...
namespace PerformanceManagement.Migrations
{
    ...
    [Migration("20200715053631_add-57")]
    partial class add57
    {
            ...
            modelBuilder.Entity("PerformanceManagement.Models.EvaluationAcceptanceStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 7, 15, 10, 6, 30, 52, DateTimeKind.Local).AddTicks(1257),
                            Title = "تفاهم"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 2,
                            CreatedDate = new DateTime(2020, 7, 15, 10, 6, 30, 54, DateTimeKind.Local).AddTicks(9723),
                            Title = "دستوری"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 3,
                            CreatedDate = new DateTime(2020, 7, 15, 10, 6, 30, 54, DateTimeKind.Local).AddTicks(9749),
                            Title = "صرف نظر"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 4,
                            CreatedDate = new DateTime(2020, 7, 15, 10, 6, 30, 54, DateTimeKind.Local).AddTicks(9756),
                            Title = "نامشخص"
                        });
                });
            ...
            modelBuilder.Entity("PerformanceManagement.Models.NotificationTitle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 7, 15, 10, 6, 30, 61, DateTimeKind.Local).AddTicks(9333),
                            Title = "تغییر وضعیت تفاهم وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 2,
                            CreatedDate = new DateTime(2020, 7, 15, 10, 6, 30, 62, DateTimeKind.Local).AddTicks(831),
                            Title = "تغییر وضعیت تفاهم شایستگی ها"
                        },
                        new
                        {
                            NotificationTitleId = 3,
                            CreatedDate = new DateTime(2020, 7, 15, 10, 6, 30, 62, DateTimeKind.Local).AddTicks(966),
                            Title = "تعیین وضعیت سایرارزیاب وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 4,
                            CreatedDate = new DateTime(2020, 7, 15, 10, 6, 30, 62, DateTimeKind.Local).AddTicks(975),
