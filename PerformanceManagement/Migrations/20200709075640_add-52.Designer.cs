...
namespace PerformanceManagement.Migrations
{
    ...
    [Migration("20200709075640_add-52")]
    partial class add52
    {
            ...
            modelBuilder.Entity("PerformanceManagement.Models.EvaluationAcceptanceStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 7, 9, 12, 26, 39, 317, DateTimeKind.Local).AddTicks(7790),
                            Title = "تفاهم"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 2,
                            CreatedDate = new DateTime(2020, 7, 9, 12, 26, 39, 326, DateTimeKind.Local).AddTicks(2858),
                            Title = "دستوری"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 3,
                            CreatedDate = new DateTime(2020, 7, 9, 12, 26, 39, 326, DateTimeKind.Local).AddTicks(2895),
                            Title = "صرف نظر"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 4,
                            CreatedDate = new DateTime(2020, 7, 9, 12, 26, 39, 326, DateTimeKind.Local).AddTicks(2901),
                            Title = "نامشخص"
                        });
                });
            ...
            modelBuilder.Entity("PerformanceManagement.Models.NotificationTitle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 7, 9, 12, 26, 39, 333, DateTimeKind.Local).AddTicks(4501),
                            Title = "تغییر وضعیت تفاهم وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 2,
                            CreatedDate = new DateTime(2020, 7, 9, 12, 26, 39, 333, DateTimeKind.Local).AddTicks(5900),
                            Title = "تغییر وضعیت تفاهم شایستگی ها"
                        },
                        new
                        {
                            NotificationTitleId = 3,
                            CreatedDate = new DateTime(2020, 7, 9, 12, 26, 39, 333, DateTimeKind.Local).AddTicks(5935),
                            Title = "تعیین وضعیت سایرارزیاب وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 4,
                            CreatedDate = new DateTime(2020, 7, 9, 12, 26, 39, 333, DateTimeKind.Local).AddTicks(5944),
