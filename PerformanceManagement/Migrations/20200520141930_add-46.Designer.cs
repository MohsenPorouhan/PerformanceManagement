...
namespace PerformanceManagement.Migrations
{
    ...
    [Migration("20200520141930_add-46")]
    partial class add46
    {
            ...
            modelBuilder.Entity("PerformanceManagement.Models.EvaluationAcceptanceStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 5, 20, 18, 49, 30, 116, DateTimeKind.Local).AddTicks(3195),
                            Title = "تفاهم"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 2,
                            CreatedDate = new DateTime(2020, 5, 20, 18, 49, 30, 118, DateTimeKind.Local).AddTicks(3938),
                            Title = "دستوری"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 3,
                            CreatedDate = new DateTime(2020, 5, 20, 18, 49, 30, 118, DateTimeKind.Local).AddTicks(3956),
                            Title = "صرف نظر"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 4,
                            CreatedDate = new DateTime(2020, 5, 20, 18, 49, 30, 118, DateTimeKind.Local).AddTicks(3959),
                            Title = "نامشخص"
                        });
                });
            ...
            modelBuilder.Entity("PerformanceManagement.Models.NotificationTitle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 5, 20, 18, 49, 30, 123, DateTimeKind.Local).AddTicks(9457),
                            Title = "تغییر وضعیت تفاهم وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 2,
                            CreatedDate = new DateTime(2020, 5, 20, 18, 49, 30, 123, DateTimeKind.Local).AddTicks(9894),
                            Title = "تغییر وضعیت تفاهم شایستگی ها"
                        },
                        new
                        {
                            NotificationTitleId = 3,
                            CreatedDate = new DateTime(2020, 5, 20, 18, 49, 30, 123, DateTimeKind.Local).AddTicks(9907),
                            Title = "تعیین وضعیت سایرارزیاب وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 4,
                            CreatedDate = new DateTime(2020, 5, 20, 18, 49, 30, 123, DateTimeKind.Local).AddTicks(9912),
