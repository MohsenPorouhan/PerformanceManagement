...
namespace PerformanceManagement.Migrations
{
    ...
    [Migration("20200711104435_add-53")]
    partial class add53
    {
            ...
            modelBuilder.Entity("PerformanceManagement.Models.EvaluationAcceptanceStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 7, 11, 15, 14, 34, 512, DateTimeKind.Local).AddTicks(8381),
                            Title = "تفاهم"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 2,
                            CreatedDate = new DateTime(2020, 7, 11, 15, 14, 34, 520, DateTimeKind.Local).AddTicks(6916),
                            Title = "دستوری"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 3,
                            CreatedDate = new DateTime(2020, 7, 11, 15, 14, 34, 520, DateTimeKind.Local).AddTicks(6938),
                            Title = "صرف نظر"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 4,
                            CreatedDate = new DateTime(2020, 7, 11, 15, 14, 34, 520, DateTimeKind.Local).AddTicks(6942),
                            Title = "نامشخص"
                        });
                });
            ...
            modelBuilder.Entity("PerformanceManagement.Models.NotificationTitle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 7, 11, 15, 14, 34, 527, DateTimeKind.Local).AddTicks(3127),
                            Title = "تغییر وضعیت تفاهم وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 2,
                            CreatedDate = new DateTime(2020, 7, 11, 15, 14, 34, 527, DateTimeKind.Local).AddTicks(4279),
                            Title = "تغییر وضعیت تفاهم شایستگی ها"
                        },
                        new
                        {
                            NotificationTitleId = 3,
                            CreatedDate = new DateTime(2020, 7, 11, 15, 14, 34, 527, DateTimeKind.Local).AddTicks(4305),
                            Title = "تعیین وضعیت سایرارزیاب وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 4,
                            CreatedDate = new DateTime(2020, 7, 11, 15, 14, 34, 527, DateTimeKind.Local).AddTicks(4313),
