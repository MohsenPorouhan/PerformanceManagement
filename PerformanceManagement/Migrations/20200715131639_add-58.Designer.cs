...
namespace PerformanceManagement.Migrations
{
    ...
    [Migration("20200715131639_add-58")]
    partial class add58
    {
            ...
            modelBuilder.Entity("PerformanceManagement.Models.EvaluationAcceptanceStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 7, 15, 17, 46, 39, 184, DateTimeKind.Local).AddTicks(5801),
                            Title = "تفاهم"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 2,
                            CreatedDate = new DateTime(2020, 7, 15, 17, 46, 39, 186, DateTimeKind.Local).AddTicks(6513),
                            Title = "دستوری"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 3,
                            CreatedDate = new DateTime(2020, 7, 15, 17, 46, 39, 186, DateTimeKind.Local).AddTicks(6532),
                            Title = "صرف نظر"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 4,
                            CreatedDate = new DateTime(2020, 7, 15, 17, 46, 39, 186, DateTimeKind.Local).AddTicks(6537),
                            Title = "نامشخص"
                        });
                });
            ...
            modelBuilder.Entity("PerformanceManagement.Models.NotificationTitle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 7, 15, 17, 46, 39, 191, DateTimeKind.Local).AddTicks(2663),
                            Title = "تغییر وضعیت تفاهم وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 2,
                            CreatedDate = new DateTime(2020, 7, 15, 17, 46, 39, 191, DateTimeKind.Local).AddTicks(3457),
                            Title = "تغییر وضعیت تفاهم شایستگی ها"
                        },
                        new
                        {
                            NotificationTitleId = 3,
                            CreatedDate = new DateTime(2020, 7, 15, 17, 46, 39, 191, DateTimeKind.Local).AddTicks(3474),
                            Title = "تعیین وضعیت سایرارزیاب وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 4,
                            CreatedDate = new DateTime(2020, 7, 15, 17, 46, 39, 191, DateTimeKind.Local).AddTicks(3479),
