...
namespace PerformanceManagement.Migrations
{
    ...
    [Migration("20200713094520_add-55")]
    partial class add55
    {
            ...
            modelBuilder.Entity("PerformanceManagement.Models.EvaluationAcceptanceStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 7, 13, 14, 15, 20, 47, DateTimeKind.Local).AddTicks(2532),
                            Title = "تفاهم"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 2,
                            CreatedDate = new DateTime(2020, 7, 13, 14, 15, 20, 52, DateTimeKind.Local).AddTicks(2821),
                            Title = "دستوری"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 3,
                            CreatedDate = new DateTime(2020, 7, 13, 14, 15, 20, 52, DateTimeKind.Local).AddTicks(2853),
                            Title = "صرف نظر"
                        },
                        new
                        {
                            EvaluationAcceptanceStatusId = 4,
                            CreatedDate = new DateTime(2020, 7, 13, 14, 15, 20, 52, DateTimeKind.Local).AddTicks(2861),
                            Title = "نامشخص"
                        });
                });
            ...
            modelBuilder.Entity("PerformanceManagement.Models.NotificationTitle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 7, 13, 14, 15, 20, 58, DateTimeKind.Local).AddTicks(9624),
                            Title = "تغییر وضعیت تفاهم وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 2,
                            CreatedDate = new DateTime(2020, 7, 13, 14, 15, 20, 59, DateTimeKind.Local).AddTicks(730),
                            Title = "تغییر وضعیت تفاهم شایستگی ها"
                        },
                        new
                        {
                            NotificationTitleId = 3,
                            CreatedDate = new DateTime(2020, 7, 13, 14, 15, 20, 59, DateTimeKind.Local).AddTicks(753),
                            Title = "تعیین وضعیت سایرارزیاب وظایف"
                        },
                        new
                        {
                            NotificationTitleId = 4,
                            CreatedDate = new DateTime(2020, 7, 13, 14, 15, 20, 59, DateTimeKind.Local).AddTicks(761),
