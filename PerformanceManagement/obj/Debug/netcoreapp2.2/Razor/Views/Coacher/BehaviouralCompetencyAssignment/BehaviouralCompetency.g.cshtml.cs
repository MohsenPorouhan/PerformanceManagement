#pragma checksum "D:\PerformanceManagement\PerformanceManagement\Views\Coacher\BehaviouralCompetencyAssignment\BehaviouralCompetency.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7ea4f9d0e9a9d05f63625088ade4b097205e222d"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7ea4f9d0e9a9d05f63625088ade4b097205e222d", @"/Views/Coacher/BehaviouralCompetencyAssignment/BehaviouralCompetency.cshtml")]
    ...
    <div class=""col-md-12"">
        <div class=""portlet blue box"">
            ...
            <div class=""portlet-body"">
                ...
                <a id=""BehaviouralCompetencyAssignmentBtn"" class=""btn blue btn-sm pull-left"" data-toggle=""modal"">اختصاص شایستگی رفتاری</a>

                <a id=""BehaviouralWeightAssignmentBtn"" class=""btn blue btn-sm pull-left"" data");
            WriteLiteral("-toggle=\"modal\">تخصیص وزن به شایستگی کارمند انتخاب شده</a>\r\n\r\n");
            EndContext();
            BeginContext(5829, 2365, true);
            WriteLiteral(@"
                <div class=""btn-group"">
                    ...
                    <ul class=""dropdown-menu"" role=""menu"">
                        ...
                        <li>
                            <a class=""competencyScoreAssignmentBtn"" coacherType=""2"">
                                به عنوان مربی فرعی (اختصاص غیرمستقیم)
                            </a>
                        </li>
                    </ul>
                </div>
                <a id=""renewCompetencyContract"" clas");
            WriteLiteral(@"s=""btn blue btn-sm pull-left"" data-toggle=""modal"">تغییر وضعیت تفاهم</a>
                <div class=""clearfix"">
                </div>
 ...
 ");
            ...
            ""fnDrawCallback"": function (oSettings) {
                    ...
                    $.ajax(
                        {
                            ...
                            type: ""GET"",
                            datatype: 'html',
                            data: { periodDefinition");
                WriteLiteral(@"Id: $(this).attr(""periodDefinitionId"") },
                ...
                $("".deleteCompetencyAssignmentBtn"").click(function () {
                    ...
                    DeleteC");
                WriteLiteral(@"ompetencyView.AllocatorDepartmentId = row.data().AllocatorEvaluationBehaviouralHierarchyId;
                ...
                WriteLiteral(@"           //data: ""firstName="" + $(""fn"").val(),
                            ...
                            success: function (data, textStatus, jqXHR) {
                                ...
                                if (data.notAllowed) {
                                    var message = """";
                                    message += ""<span>شایستگی رفتاری که فقط خود اختصاص دهنده آن هستید قابل حذف می باشد.</span><br><br>"";
          ...
          ");
                ...
                },
                {
                    ...
                    ""render"": function (data, type, row, meta) {
                        if (data == ""1"") {
                            data = ""<span class='label label-sm label-success'>تف");
                WriteLiteral(@"اهم</span>"";
                        }
                        else if (data == ""2"") {
                ...
                //},
                {
                    ""mData"": null,
                    ""render"": function (data, type, row, meta) {
                        data = ""<a href='#' data-toggle='modal' periodDefinitionId="" + row.PeriodDefinitoionId + "" class='btn viewScoreBtn'><i class='fa f");
                WriteLiteral(@"a-eye'></i></a>"";
                        return data;
                    }
                },
                {
    ...
    $(""#competencyAssignmentTable_filter"").after(""<div id='dataTables_filter_employee' class='dataTables_filter input-DT hidden'><label>انتخاب کارمند :<select name='employeeId' id='employeeId' class='form-control input-medium'></select></label></div>"");

    $(""#competencyAssignmentTable_filter"").after(""<div id");
                WriteLiteral(@"='dataTables_filter_subSet' class='dataTables_filter input-DT hidden'><label><select name='subSetDepartmentIdDT' id='subSetDepartmentIdDT' class='form-control input-medium'></select></label></div>"");
    ...
    //       ");
                WriteLiteral(@" $(""#periodDefinitionIdDT"").append(""<option></option>"");
    ...
    $('#periodDefinitionIdDT').on('change', function () {
        ...
        $.ajax({
            ...
            success: function (DepartmentResponsibilty) {
                ...
                $(""#departmentIdDT ");
                WriteLiteral(@"#departmentId"").empty();
    ...
    ");
                WriteLiteral(@"        if (node.element.className == 'level_0' || node.element.className == 'level_1') {
    ...
    function buildHierarchy(arry) {
        ...
        var findChildren = function (parent) {
            if (children[parent.value.EvaluationHierarchyId]) {
                parent.chi");
                WriteLiteral(@"ldren = children[parent.value.EvaluationHierarchyId];
                $(parent.children).each(function (i, p) {
                    ...
                    if ($(""#subSetDepartmentIdDT option[parent='"" + p.value.parent + ""']:last"").length > 0) {
                        ...
                        $(""<option parent="" + parent.value.EvaluationHierarchyId + "" class='level_"" + p.value.Levell + ""' value='"" + p.value.EvaluationHierarchyId + ""'>"" + p.value.text + ""</option>"").insertAfter(""#subSetDepartmentIdDT opti");
                WriteLiteral(@"on[value='"" + p.value.parent + ""']"");
                    }
    ...
    $('#departmentId').on('change', function () {
        ...
        //    dt.ajax.url(""/AssignTask/GetTaskAssignmen");
                WriteLiteral(@"tList"");
        //    dt.ajax.reload();
        //}
        $.ajax({
           ...
           ");
                WriteLiteral(@"             placeholder: ""انتخاب واحد زیر مجموعه"",
                        allowClear: true,
                        width: ""300px"",
                    ...
                    $.ajax({
                        ...
                        success: function (subSetEmployees) {
                            ...
                            $(subSetEmployees).each(function (i, p) {
                                $(""#employeeId"").append(""<opti");
                WriteLiteral(@"on value='"" + p.PeopleId + ""-"" + p.EvaluationHierarchyID + ""'>"" + p.FullName + ""</option>"");
                            })
    ...
    $('#subSetDepartmentIdDT').on('change', function () {
        ...
        $.ajax({
            type: 'get',
            url: '/TaskAssignment/GetDirectEmployees',
            data: { departmentId: $('#subSetDepartmentIdDT').children('o");
    ...
    $(""#BehaviouralWeightAssignmentBtn"").click(function () {
        if (!dt.data().count()) {
            ...
            $.ajax(
                {
                    url: ""/BehaviouralCompetencyAssignment/BehaviouralWei");
                WriteLiteral(@"ghtAssignment"",
                    contentType: 'aplication/json;charset=utf-8',
                    type: ""GET"",
                    datatype: 'html',
    ...
    $("".competencyScoreAssignmentBtn"").click(function () {
        ...
        else if ($('#periodDefinitionIdDT').children('option:selected').val() != """" && $('#periodDefinitionIdDT').children('option:selected').val() != null && $('#departmen");
                WriteLiteral(@"tId').children('option:selected').val() != """" && $('#departmentId').children('option:selected').val() != null && $('#employeeId').children('option:selected').val() != """" && $('#employeeId').children('option:selected').val() != null) {
            $.ajax(
                {
      ...
      ");
                WriteLiteral(@"      alert(""دوره و رده سازمانی و انتخاب زیر مجموعه و کارمند می بایست در حالت انتخاب باشد"");
        }
    });
