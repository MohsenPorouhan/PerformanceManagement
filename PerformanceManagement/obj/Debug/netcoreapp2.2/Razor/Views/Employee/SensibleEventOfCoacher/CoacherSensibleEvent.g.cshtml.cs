#pragma checksum "D:\PerformanceManagement\PerformanceManagement\Views\Employee\SensibleEventOfCoacher\CoacherSensibleEvent.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "53e549a9dc54f9c93f45c083ff6f7ebb0b2bb2e1"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Employee_SensibleEventOfCoacher_CoacherSensibleEvent), @"mvc.1.0.view", @"/Views/Employee/SensibleEventOfCoacher/CoacherSensibleEvent.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/Employee/SensibleEventOfCoacher/CoacherSensibleEvent.cshtml", typeof(AspNetCore.Views_Employee_SensibleEventOfCoacher_CoacherSensibleEvent))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"53e549a9dc54f9c93f45c083ff6f7ebb0b2bb2e1", @"/Views/Employee/SensibleEventOfCoacher/CoacherSensibleEvent.cshtml")]
    ...
    public class Views_Employee_SensibleEventOfCoacher_CoacherSensibleEvent : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
#line 1 "D:\PerformanceManagement\PerformanceManagement\Views\Employee\SensibleEventOfCoacher\CoacherSensibleEvent.cshtml"
    ...
    <div class=""col-md-12"">
        <div class=""portlet blue box"">
            <div class=""portlet-title"">
                <div class=""caption"">
                    <i class=""fa fa-cogs""></i> مشاهده وقایع حساس ثبت شده مربی برای کارمند در صورت قابلیت مشاهده
                </div>
                <div class=""tools"">
...
");
            EndContext();
            BeginContext(4765, 1308, true);
            WriteLiteral(@"
                <div class=""clearfix"">
                </div>
                <table class=""table table-striped table-hover table-bordered"" id=""coacherSensibleEventTbl"">
                    <thead>
                        <tr>
                            <th>
                                عنوان
...
<script>
    ...
    function relatedTaskCompetency(d) {
        var r;
        $.ajax({
            url: ""/SensibleEventOfCoacher/GetRelatedTaskCompetencyList"",
            type: ""POST"",
    ...
    function show_dataTable() {
        dt = $('#coacherSensibleEventTbl').DataTable({
            ...
            ""fnDrawCallback"": function (oSettings) {
                ...
                // ");
                WriteLiteral(@"Array to track the ids of the details displayed rows
                var detailRows = [];
                ...
                // On each draw, loop o");
                WriteLiteral(@"ver the `detailRows` array and show any child rows
                dt.on('draw', function () {
            ...
            ""serverSide"": true,
            ""ajax"": {
                ""url"": ""/SensibleEventOfCoacher/GetSensibleEventOfCoacherList"",
                ""type"": ""Post"",
                ""data"": function (d) {
  ...
  ");
            ...
            ""aoColumns"": [
                ...
                },
                {
                    ...
                    ""render"": function (d");
                WriteLiteral(@"ata, type, row, meta) {
    ...
    $(""#coacherSensibleEventTbl_filter"").after(""<div id='departmentIdDT' class='dataTables_filter input-DT'><label>رده سازمانی:<select name='departmentId' id='departmentId' class='form-control input-medium'></select></label></div>"");

    $(""#coacherSensibleEventTbl_filter"").after(""<div class='dataTables_filter input-DT'><label>دوره:<select name='periodDefinitionIdDT' id='periodDefinitionIdDT' class='form-control input---medium'></select></label></div>"");

    $(""#coacherSensibleEventTbl_filter"").after(""<div class='clearfix'></div>"");
    ...
    $.ajax({
        ...
        success: function (periodDefinition) {
            ...
            var max = 0;
            $(period");
                WriteLiteral(@"Definition).each(function (i, p) {
    ...
    $('#periodDefinitionIdDT').on('change', function () {
        $.ajax({
            ...
            success: function (DepartmentResponsibilty) {
                ...
                $(""#department");
                WriteLiteral(@"IdDT #departmentId"").append(""<option></option>"");
    ...
    $('#departmentId').on('change', function () {
        dt.ajax.url(""/SensibleEventOfCoacher/GetSensibleEventOfCoacherList"");
        dt.ajax.reload();
    });

        //$(""#reload"").click(function () {
        //    $(""#em");
                WriteLiteral(@"ployeeId"").val("""");
        //    $(""#departmentId"").val("""");
