#pragma checksum "D:\PerformanceManagement\PerformanceManagement\Views\PlanningAdmin\AssignTask\AssignScoreOLD.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ae1ac6aec998f405335c4c59b55949d23d525537"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_PlanningAdmin_AssignTask_AssignScoreOLD), @"mvc.1.0.view", @"/Views/PlanningAdmin/AssignTask/AssignScoreOLD.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/PlanningAdmin/AssignTask/AssignScoreOLD.cshtml", typeof(AspNetCore.Views_PlanningAdmin_AssignTask_AssignScoreOLD))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ae1ac6aec998f405335c4c59b55949d23d525537", @"/Views/PlanningAdmin/AssignTask/AssignScoreOLD.cshtml")]
    ...
    public class Views_PlanningAdmin_AssignTask_AssignScoreOLD : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#line 1 "D:\PerformanceManagement\PerformanceManagement\Views\PlanningAdmin\AssignTask\AssignScoreOLD.cshtml"
...
#line hidden
            ...
            WriteLiteral("\r\n");
            EndContext();
            BeginContext(29, 2092, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "ae1ac6aec998f405335c4c59b55949d23d5255375977", async() => {
                BeginContext(94, 2020, true);
                WriteLiteral(@"
...
<script type=""text/html"" id=""addChild"">
    <div class=""row"">
        ...
        <!--/span-->
        <div class=""col-md-6"">
            <button id=""criteriaScoreBtn{0}"" type=""button"" loadCriteria=""false"" index=""{0}"" data-toggle=""modal"" @*href=""#criteriaModal{0}"" *@ taskId=""{2}"" class=""btn btn-link criteria");
            WriteLiteral(@"Btn"">ثبت نمره عملکردی شاخص ها</button>
        </div>
    </div>
</script>
                ...
                <div class=""modal-body"">
                    <div class=""form-body"">
                        ...
                        <div id=""alert_danger"" class=""alert alert-danger display-hide"">
                            <button class=""close"" data-close=""alert""></button>
  ");
            WriteLiteral(@"                          پر کردن فيلدهاي ستاره دار اجباري مي باشد.
                        </div>
...
<script>
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data == 1) {
                $(""#weightWayInfo"")");
            WriteLiteral(@".html(""نمره دهی به صورت درصدی و بازه مجاز از 1 تا 100 می باشد."");
            } else if (data == 2) {
                $.ajax({
                    type: 'get',
...
");
            WriteLiteral(@"                                required: ""پرکردن این فیلد الزامی می باشد"",
                        ...
                        if (weightWay == 1) {
                            ...
                            $(""#criteriaWeight"" + index2).rules(""add"", {
                                range: [Math.min.apply(Math");
            WriteLiteral(@", numberScaleList), Math.max.apply(Math, numberScaleList)],
                                messages: {
   ...
   ");
        ...
        if (form.valid() == false) {
            ...
            $(""#taskRow input[type=text]"").each(function () {
                ...
                var score = {}
         ");
            WriteLiteral(@"       evaluation.TaskId = $(this).attr(""taskId"");
            ...
            $.ajax(
                {
                    ...
                    //data:postdata,
                    url: ""/Assi");
            WriteLiteral(@"gnTask/AssignScore"",
                    //url : formURL,
                    //                        data: postdata2,
