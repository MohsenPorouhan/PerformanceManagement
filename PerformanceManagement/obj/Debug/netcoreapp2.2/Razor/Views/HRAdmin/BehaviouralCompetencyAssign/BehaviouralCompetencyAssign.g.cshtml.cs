#pragma checksum "D:\PerformanceManagement\PerformanceManagement\Views\HRAdmin\BehaviouralCompetencyAssign\BehaviouralCompetencyAssign.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7fa2295460d584bf7e690390b61bc32424e13da9"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_HRAdmin_BehaviouralCompetencyAssign_BehaviouralCompetencyAssign), @"mvc.1.0.view", @"/Views/HRAdmin/BehaviouralCompetencyAssign/BehaviouralCompetencyAssign.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/HRAdmin/BehaviouralCompetencyAssign/BehaviouralCompetencyAssign.cshtml", typeof(AspNetCore.Views_HRAdmin_BehaviouralCompetencyAssign_BehaviouralCompetencyAssign))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7fa2295460d584bf7e690390b61bc32424e13da9", @"/Views/HRAdmin/BehaviouralCompetencyAssign/BehaviouralCompetencyAssign.cshtml")]
    ...
    public class Views_HRAdmin_BehaviouralCompetencyAssign_BehaviouralCompetencyAssign : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
#line 1 "D:\PerformanceManagement\PerformanceManagement\Views\HRAdmin\BehaviouralCompetencyAssign\BehaviouralCompetencyAssign.cshtml"
  
    ViewData["Title"] = "تخصیص شایستگی رفتاری عمومی";

#line default
#line hidden
            DefineSection("Styles", async() => {
                BeginContext(78, 1374, true);
                WriteLiteral(@"
    ...
    <div class=""col-md-12"">
        <div class=""portlet blue box"">
            <div class=""portlet-title"">
                <div class=""caption"">
                    <i class=""fa fa-cogs""></i>تخصیص شایستگی های رفتاری عمومی
                </div>
                <div class=""tools"">
            ...
            <div class=""portlet-body"">
                ...
                <a id=""competencyAssignBtn"" class=""btn blue btn-sm pull-left"" data-toggle=""modal"">تخصیص شایستگی های عمومی با انتخاب سلسله مراتب<");
            WriteLiteral(@"/a>

                <a id=""competencyAssignWithoutHierarchyBtn"" class=""btn blue btn-sm pull-left"" data-toggle=""modal"">تخصیص شایستگی های رفتاری بدون انتخاب سلسله مراتب</a>


                <div class=""clearfix"">
                </div>
                <table class=""table table-striped table-bordered table-hover"" id=""competencyAssignTable"">
                    <thead>
                        <tr>
                            <th>
                                کد دوره
                            ...
                            <th>
  ");
            WriteLiteral(@"                              نام شایستگی رفتاری
                            </th>
                            <th>
                                وزن
                            </th>
...
<script src=""/assets/advancedDat");
            ...
            DefineSection("Scripts", async() => {
                BeginContext(6574, 12602, true);
                WriteLiteral(@"
<script>
    var dt;
    function show_dataTable() {
        dt = $('#competencyAssignTable').DataTable({
            ...
            ""fnDrawCallback"": function (oSettings");
                WriteLiteral(@") {
                $("".editCompetencyAssignmentBtn"").click(function () {
                    ...
                    $.ajax(
                        {
                            ...
                            data: {
                                ...
                                , behaviouralCompetencyWeight: row.data().BehaviouralCompetencyWeight
                                , title: row.data().Title
                                , evaluationBehaviouralParticipantId: row.data().EvaluationBehaviouralParticipantId
                                , participantEvaluationBehaviouralHierarchyId: row.data().Participant");
                WriteLiteral(@"EvaluationBehaviouralHierarchyId
                ...
                $("".competencyDeletetionBtn"").click(function () {
                    var tr3 = $(this).closest('tr');
                    var row3 = dt.row(tr3);
                    $.ajax(
                        {
                            url: ""/BehaviouralCompetencyAssign/BehaviouralCompetencyAssignmentDel");
                WriteLiteral(@"etion"",
                            contentType: 'aplication/json;charset=utf-8',
                            type: ""GET"",
                            datatype: 'html',
                            data: {
                                evaluationBehaviouralCompetencyId: row3.data().EvaluationBehaviouralCompetencyId,
   ...
   ");
            ...
            ""processing"": true,
            ""ajax"": {
                ""url"": ""/BehaviouralCompetencyAssign/GetAssignmentBehaviouralList"",
                ""type"": ""post"",
                ""data"": function (d) {
            ...
            ""aoColumns"": [
                ...
                { ""mData"": ""participantDepartmentName"" },
                {
                    ...
                    ""render"": function (data, type, row, meta) {
                        data = ""<a href='#public_task' data-toggle='modal' class='btn editCompetencyAssignmentBtn' data-toggle='modal'><i class='fa fa-edit'></i></a>"";
                        return data;
                    }
                },
                {
                    ""mData"": null,
                    ""render"": function (data, type, row, meta) {
                        data = ""<a href='#' data-toggle='modal' class='competencyDeletetionBtn'><i class='fa fa-trash-o'></i></a>"";
                        return data;
           ");
                WriteLiteral(@"         }
                }
    ...
    $(""#competencyAssignTable_filter"").after(""<div class='dataTables_filter input-DT'><label class='control-label'><select name='peopleIdDT' id='peopleIdDT' class='form-control input-medium select2-dt'><option></option></select></label></div>"");

    $(""#competencyAssignTable_filter"").after(""<div class='dataTables_filter input-DT'><label class='control-label'><select name='departmentIdDT' id='departmentIdDT' class='form-control input-medium select2-dt'><option></option></select></label></div>"");

    $(""#competencyAssignTable_filter"").after(""<div class='dataTables_filter input-DT'><label class='control-label'><select name='periodDefinitionIdDT' id='periodDefinitionIdDT' class='form-control input-medium select2-dt'></select></label></div>"");

    $(""#competencyAssignTable_filter"").after(""<div class='clearfix'></div>"");
    ...
    $");
                WriteLiteral(@"('#periodDefinitionIdDT').on('change', function () {
        ...
        $.ajax({
            type: 'get',
            url: '/BehaviouralCompetencyAssign/GetPublicCompetencyDepartment',
            ...
            success: function (periodDefinition) {
                ...
                $(periodDefinition).each(function (i, p) {
                    //$(""#parentName"").select2(""val"", d.departmentId);
                    $(""#departmentIdDT"").append(""<option value='"" + p.EvaluationHierarchyId + ""'>"" ");
                WriteLiteral(@"+ p.ShortName + ""</option>"");
                })
                $('#departmentIdDT').select2({
                    placeholder: ""واحد سازمانی"",
                    allowClear: true
    ...
    $('#departmentIdDT').on('change', function () {
        ...
        $.ajax({
            type: 'get',
            url: '/BehaviouralCompetencyAssign/GetPublicCompetencyReceiver',
    ...
    $(""#competencyAssignBtn"").click(function () {
        $.ajax(
            {
                url: ""/BehaviouralCompetencyAssign/BehaviouralCompetencyAssignWithHierarchy"",
                contentType: 'aplication/json;charset=utf-8',
                type: ""GET"",
                datatype: 'html',
    ...
    $(""#competencyAssignWithoutHierarchyBtn"").click(function () {
        $.ajax(
            {
                url: ""/BehaviouralCompetencyAssign/BehaviouralCompetencyAssignWithoutHierarchy"",
                contentType: 'aplication/json;charset=utf-8',
                type: ""GET"",
                datatype: 'html',
                //data: { CoacherType: $(this).attr(""coacherType"") },
                success: function (data, textStatus, jqXHR) {
                    ...
                    //this always must have 1  periodDefinitionId
                    //$(""#period");
                WriteLiteral(@"DefinitionId option:eq(1)"").attr(""selected"", ""selected"")
                },
                error: function (jqXHR, textStatus, errorThrown) {
                    alert(""erorr"");
                    alert(jqXHR);
