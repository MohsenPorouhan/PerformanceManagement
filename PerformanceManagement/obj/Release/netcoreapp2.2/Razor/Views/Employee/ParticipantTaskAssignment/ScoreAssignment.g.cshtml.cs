#pragma checksum "D:\PerformanceManagement\PerformanceManagement\Views\Employee\ParticipantTaskAssignment\ScoreAssignment.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9eab01d9ebef56661c72f04ab5d0b7722d91169f"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Employee_ParticipantTaskAssignment_ScoreAssignment), @"mvc.1.0.view", @"/Views/Employee/ParticipantTaskAssignment/ScoreAssignment.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/Employee/ParticipantTaskAssignment/ScoreAssignment.cshtml", typeof(AspNetCore.Views_Employee_ParticipantTaskAssignment_ScoreAssignment))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9eab01d9ebef56661c72f04ab5d0b7722d91169f", @"/Views/Employee/ParticipantTaskAssignment/ScoreAssignment.cshtml")]
    ...
    public class Views_Employee_ParticipantTaskAssignment_ScoreAssignment : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#line 1 "D:\PerformanceManagement\PerformanceManagement\Views\Employee\ParticipantTaskAssignment\ScoreAssignment.cshtml"
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9eab01d9ebef56661c72f04ab5d0b7722d91169f6068", async() => {
                BeginContext(97, 1959, true);
                WriteLiteral(@"
            ...
            <div class=""form-group"">
                ...
                <div class=""col-md-6"">
                    <div class=""input-icon right"">
                        <i class=""fa""></i>
                        <input type=""text"" name=""taskScore{0}"" id=""taskScore{0}"" taskId=""{2}"" evaluationId=""{3}"" periodDefinitionId=""{4}"" class=""form-control taskScore input-small input-sm"" />
                    </div>
                </div>
            </div>
        </div>
    </div>
    <div class=""criteriaItems"" id=""appendCriteriaScoreHolder{0}"" index=""{0}"" taskId=""{2}"" loadCriteria=""false""></div>
</script>
<script type=""text/html"" id=""appendCriteriaScor");
            WriteLiteral(@"eRow"">
...
<script>
    ...
    $(selector).each(function (i, tr) {
        ...
        if (row.data().Confirmation == true) {
            ...
            $(template(index, row.data().TaskTitle, row.data().TaskId, row.data().EvaluationId, row.data().PeriodDefinitoionId, row.data().Levell - 1)).appendTo(""#taskScoreRow"");
                ...
                success: function (data) {
                    if (data >= 1) {
                        ...
                        if (index == 0) {
                            isTrue = true;
                      ");
            WriteLiteral(@"      //taskScore0Value = row.data().taskScore;
    ...
    if (!finalResult) {
        alert(""وظیفه هایی را که وضعیت آن در حالت پذیرش باشد را مجاز به نمره دهی می باشید."");
    } else if (finalResult) {
        var weightWay = """";
        var numberScaleList = [];
      ");
            ...
            success: function (data) {
                ...
                if (data == 1) {
                    ...
                    $.ajax({
                      ...
                      ");
            WriteLiteral(@"          $(""#weightWayInfo"").append(d.numberScale + "":"" + d.titleScale + ""  "");
                            });
                        },
                        error: function (status) {
                            alert(""Error"");
        ...
        $("".criteriaItems"").each(function () {
            ...
            if ($(this).attr(""loadCriteria"") == ""false"") {
                $.ajax({
                    type: 'get',
                    url: '/TaskAssignment/GetCriteriaDetails',
                    data: { taskId: $");
            WriteLiteral(@"(this).attr(""taskId"") },
                    success: function (data) {
                        $(data).each(function (i2, d) {
                            index2 = j++;
                            var i3 = i2 + 1;
                            if (i3 % 2 == 0) {
                                $(template4(index2, d.title, d.criteriaId)).appendTo(""#appendCriteriaScoreHolder"" + index + "" .row[rowIndex='"" + (index2 - 1) + ""']"");
                            }
                            else if (i3 % 2 == 1) {
                                $(template3(index2, d.title, d.criteriaId)).appendTo(""#appendCriteriaScoreHolder"" + index);
                            }
            ...
            WriteLiteral(@"        }
                            ...
                            if (weightWay == 1) {
                                ...
                                $(""#criteriaWeight"" + index2).rules(""add"", {
                                    range: [Math.min.apply(Math, numberScaleList), Math.");
            WriteLiteral(@"max.apply(Math, numberScaleList)],
                                    messages: {
       ...
       ");
            WriteLiteral(@"             }
                ...
                unhighlight: function (element) { // revert the change done b");
            WriteLiteral(@"y hightlight
            ...
            if (form.valid() == false) {
                ...
                var coacherLavel = -1;
                $(""#taskSco");
            WriteLiteral(@"reRow > div[class=row] input[type=text]"").each(function () {
                    var evaluation = {};
                    var score = {}
                    ...
                    var criteria = $("".crit");
            WriteLiteral(@"eriaItems[taskId='"" + $(this).attr(""taskId"") + ""'] input"")
                ...
                $.ajax(
                    {
                        datatype: ""json"",
                        //data:postdata,
                        url: ""/ParticipantTaskAssignment/ScoreAssignment"",
                        //url : formURL,
                        //                        data: postdata2,
