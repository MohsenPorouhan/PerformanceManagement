#pragma checksum "D:\PerformanceManagement\PerformanceManagement\Views\Coacher\BehaviouralCompetencyAssignment\ViewScore.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7c2373a2b6f8e250d71418ae93764ba3934f9ebb"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Coacher_BehaviouralCompetencyAssignment_ViewScore), @"mvc.1.0.view", @"/Views/Coacher/BehaviouralCompetencyAssignment/ViewScore.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/Coacher/BehaviouralCompetencyAssignment/ViewScore.cshtml", typeof(AspNetCore.Views_Coacher_BehaviouralCompetencyAssignment_ViewScore))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7c2373a2b6f8e250d71418ae93764ba3934f9ebb", @"/Views/Coacher/BehaviouralCompetencyAssignment/ViewScore.cshtml")]
    ...
    public class Views_Coacher_BehaviouralCompetencyAssignment_ViewScore : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
#line 1 "D:\PerformanceManagement\PerformanceManagement\Views\Coacher\BehaviouralCompetencyAssignment\ViewScore.cshtml"
  
    Layout = null;

#line default
#line hidden
            BeginContext(27, 9628, true);
...
<script>
    ...
    $(selector).each(function (i, tr) {
        ...
        if (row.data().Levell == 2 && ((row.data().AllocatorPersonId == coacherId) || row.data().allocatorRoleName == ""HRAdmin"")) {
            $.ajax({
                url: '/BehaviouralCompetencyAssignment");
            WriteLiteral(@"/GetScore',
                data: {
            ...
            $.ajax({
                ...
                data: {
                    eva");
            WriteLiteral(@"luationBehaviouralCompetencyId: row.data().EvaluationBehaviouralCompetencyId
                    , hasParticipant: row.data().hasParticipant
                    , participantConfirmation: row.data().participantConfirmation
                    , type: 2
                },
            ...
            $.ajax({
                ...
                data: {
         ");
            WriteLiteral(@"           evaluationBehaviouralCompetencyId: row.data().EvaluationBehaviouralCompetencyId
                    , hasParticipant: row.data().hasParticipant
                    , participantConfirmation: row.data().participantConfirmation
                    , type: 2
                },
         ...
         ");
            ...
            $.ajax({
                ...
                data: {
                    ...
                    , coacherDepartmentId: row.data().AllocatorEvaluationBehaviouralHierarchyId
                    , departmentId: row.data().RecieverAllocationEvaluationBehaviouralHierarchyId
                    , personId: row.data().RecieverAllo");
            WriteLiteral(@"cationPersonId
                },
                success: function (data) {
                    allocatorLevel = data[0].Levell;
                },
            ...
            if (row.data().Levell >= ");
            WriteLiteral(@"3 && (row.data().AllocatorPersonId != coacherId && row.data().allocatorRoleName != ""HRAdmin"" && row.data().AllocatorEvaluationBehaviouralHierarchyId != row.data().parent) && coacherLevell <= allocatorLevel) {
                finalResult = true;
                $.ajax({
                    url: '/BehaviouralCompetencyAssignment/GetScore',
                    data: {
