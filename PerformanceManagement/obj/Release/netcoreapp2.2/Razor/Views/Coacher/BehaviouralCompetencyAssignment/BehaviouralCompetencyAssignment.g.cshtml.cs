#pragma checksum "D:\PerformanceManagement\PerformanceManagement\Views\Coacher\BehaviouralCompetencyAssignment\BehaviouralCompetencyAssignment.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a05a1cefbcaa1afbf965d505f739dea5ad8a55c2"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a05a1cefbcaa1afbf965d505f739dea5ad8a55c2", @"/Views/Coacher/BehaviouralCompetencyAssignment/BehaviouralCompetencyAssignment.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a05a1cefbcaa1afbf965d505f739dea5ad8a55c26241", async() => {
...
<script>
    $(document).ready(function () {
        ...
        $('#departmentSupervisor').on('change', function () {
            ...
            //    data: {
            //        departmentId: $('#departmentSupervisor').children('option:selected').val(");
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $(data).each(function (i, d) {
                        //$(""#parentName"").select2(""val"", d.departmentId);
                        $(""#subSetEmployeeId"").append(""<option value='"" + d.Evalu");
            WriteLiteral(@"ationHierarchyId + ""-"" + d.PeopleId + ""'>"" + d.fullname + ""</option>"");
                    })
                },
                error: function (status) {
                    alert(""Error"");
 ...
 ");
        ...
        $(""#competencyAssignmentFrm"").submit(function (e) {
            ...
            form.validate({
                //console.log($('#registerform').seriali");
            WriteLiteral(@"zeArray());
                ...
                messages: {
                    ...
                    departmentSupervisor: {
                        required: ""پر کردن این فیلد الزامی می ");
            WriteLiteral(@"باشد""
                    },
                    subSetEmployeeId: {
                        required: ""پر کردن این فیلد الزامی می باشد""
                ...
                highlight: functio");
            WriteLiteral(@"n (element) { // hightlight error inputs
                    $(element)
            ...
            WriteLiteral(@"                    contentType: false,
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            if (data.result > 0) {
                                ...
                                toas");
            WriteLiteral(@"tr.options.timeOut = ""15000"";
                                toastr.options.positionClass = ""toast-top-center"";
                                toastr.info(message);
                            }
                            if (data.duplicate != """") {
