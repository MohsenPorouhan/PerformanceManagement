...
{
    public class ProtestationOfPeriodHandler : AuthorizationHandler<ProtestationOfPeriodRequirement>
    {
        protected override System.Threading.Tasks.Task HandleRequirementAsync(AuthorizationHandlerContext context, ProtestationOfPeriodRequirement requirement)
        {
            ...
            SectionPeriod sectionPeriod = shareService.ProtestationOfPeriod();
