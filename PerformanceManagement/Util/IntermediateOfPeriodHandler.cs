...
{
    public class IntermediateOfPeriodHandler : AuthorizationHandler<IntermediateOfPeriodRequirement>
    {
        protected override System.Threading.Tasks.Task HandleRequirementAsync(AuthorizationHandlerContext context, IntermediateOfPeriodRequirement requirement)
        {
            ...
            SectionPeriod sectionPeriod = shareService.IntermediateOfPeriod();
