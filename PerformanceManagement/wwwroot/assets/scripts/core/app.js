...
var App = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            ...
            $('#style_color').attr("href", "../assets/css/themes/" + color_ + ".css");//add by end developer 
            $('#style_color').attr("href", "../../assets/css/themes/" + color_ + ".css");//add by end developer  

            var pathname = $(location).attr('pathname');
            var path;
            if (pathname.includes("/hradmin")) {
                path = '/hradmin';
            } else if (pathname.includes("/coacher")) {
                path = '/coacher';
            } else if (pathname.includes("/planningadmin")) {
                path = '/planningadmin';
            } else if (pathname.includes("/ictadmin")) {
                path = '/ictadmin';
            }
            ...
            if ($.cookie) {
                $.cookie('style_color', color, { path: path });
            }
        }
